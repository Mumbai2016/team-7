...
<script type="text/javascript" src="charts/js/themes/fusioncharts.theme.ocean.js"></script>
</head>
<body>
...
// Render the chart
$columnChart->render('my_div');
?>
<div id="my_div">FusionCharts will load here!</div> 
</body>
</html>